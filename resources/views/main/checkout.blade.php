...
@section('content')
    ...
    <div class="max-w-4xl mx-auto p-8 bg-white rounded-xl shadow-lg mt-8">
        ...
        <form method="POST" action="{{ route('checkout.submit') }}">
            ...
            @php
                // Contoh data keranjang (sementara hardcode)
                $checkoutItems = [
                ...
                $totalPrice = 350000; // total sementara
            @endphp
            ...
            <div class="mb-10">
                <textarea name="seller_notes" rows="3"
                          class="w-full p-3 border border-gray-400 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-600"
                          placeholder="Opsional: Tambahkan catatan khusus untuk penjual, misalnya permintaan bungkus kado atau pesan khusus.">
...
@push('scripts')
<script>
    // Script opsional untuk isi alamat default user
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (addressTextarea && addressTextarea.value.trim() === '' && defaultAddress) {
