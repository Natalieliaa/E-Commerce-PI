        ...
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center space-x-8">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    <a href="#" class="text-gray-600 hover:text-green-600 {{ request()->routeIs('seller.dashboard') ? 'font-semibold text-green-600 border-b-2 border-green-600 pb-1' : '' }}">Dashboard</a>
                    <a href="#" class="text-gray-600 hover:text-green-600 {{ request()->routeIs('seller.products*') ? 'font-semibold text-green-600' : '' }}">Produk Saya</a>
                    <a href="#  " class="text-gray-600 hover:text-green-600 {{ request()->routeIs('seller.orders') ? 'font-semibold text-green-600' : '' }}">Pesanan</a>
                </div>
            </div>
            ...
            <div class="flex items-center space-x-5">
                ...
                {{-- Add Product Button --}}
                <a href="#" class="flex items-center space-x-2 bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 hidden group-hover:block z-50">
                        <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Profil Toko</a>
